...
#include "GLContext.h"
#include "GLDebugMipmap2D.h"
#include "GLFramebuffer.h"
#include "GLGLSLProgram.h"
#include "GLMipmap.h"
#include "GLShader.h"
#include "GLTexture.h"
#include "GLTypes.h"
...
//    QOpenGLFunctions_4_5_Core *functions4_5;
    ...
    void BlitFramebuffer(GLMipmap *src, const GLRect *srcRect, GLMipmap *dst, const GLRect *dstRect, GLEnum mask,
                         GLEnum filter);
    ...
    GLTexture *
    CreateTexture2D(uint32_t width, uint32_t height, uint32_t numMipMap, GLTextureFormat format, uint32_t flags);
    ...
    void ResetBackbuffer(uint32_t width, uint32_t height, GLTextureFormat colorFormat, GLTextureFormat depthFormat,
    ...
    void
    SetDisplay(uint32_t width, uint32_t height, GLTextureFormat a4, GLTextureFormat a5, uint32_t a6, bool a7, bool a8,
               uint32_t a9);
    ...
    void
    SetShaderConstantsInternal(GLShader::ShaderType shaderType, uint32_t index, const float *constants, uint32_t count);
